...
class ShortNumberInfoTest extends TestCase
{
    ...
    public function testGetExpectedCost(): void
    {
        ...
        self::assertEquals(ShortNumberCost::PREMIUM_RATE, $this->shortInfo->getExpectedCost($premiumRateNumber));
        ...
        self::assertEquals(ShortNumberCost::STANDARD_RATE, $this->shortInfo->getExpectedCost($standardRateNumber));
        ...
        self::assertEquals(ShortNumberCost::TOLL_FREE, $this->shortInfo->getExpectedCost($tollFreeNumber));
        ...
        self::assertEquals(ShortNumberCost::UNKNOWN_COST, $this->shortInfo->getExpectedCost($unknownCostNumber));
        ...
        self::assertEquals(ShortNumberCost::TOLL_FREE, $this->shortInfo->getExpectedCost($invalidNumber));
    ...
    public function testGetExpectedCostForSharedCountryCallingCode(): void
    {
        ...
        self::assertEquals(ShortNumberCost::UNKNOWN_COST, $this->shortInfo->getExpectedCost($ambiguousTollFreeNumber));
    }
    ...
    public function testEmergencyNumberForSharedCountryCallingCode(): void
    {
        ...
        self::assertEquals(ShortNumberCost::TOLL_FREE, $this->shortInfo->getExpectedCost($sharedEmergencyNumber));
    }
    ...
    public function testCountryCallingCodeIsNotIgnored(): void
    {
        ...
        self::assertEquals(ShortNumberCost::UNKNOWN_COST, $this->shortInfo->getExpectedCostForRegion($this->parse('+4640404', RegionCode::SE), RegionCode::US));
    }
