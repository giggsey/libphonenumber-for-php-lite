...
class ShortNumberMetadata_ES extends PhoneMetadata
{
    ...
    public function __construct()
    {
        ...
        $this->tollFree = (new PhoneNumberDesc())
            ->setNationalNumberPattern('0(?:16|20|6[57]|8[58])|1(?:006|12|[3-7]\d\d)|2373|(?:116|20\d)\d{3}')
        ...
        $this->short_code = (new PhoneNumberDesc())
            ->setNationalNumberPattern('0(?:1[0-267]|2[0148]|6[0-257]|8[058]|9[12])|1(?:0[03-57]\d{1,3}|1(?:2|6(?:000|111)|8\d\d)|2\d{1,4}|[3-9]\d\d)|(?:2[0-2]\d|3[357]|[79]9[57])\d{3}|1(?:3[34]|77)|2(?:[2357]\d|80)\d\d|90(?:5[124578]|7)|2(?:2\d\d?|373)')
